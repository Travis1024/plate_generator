...
char_alp3 = "ABCDEFGHJKLMNPQRSTUVWXYZ0123456789012345678901234567890123456789012345678901234567890123456789"
...
# 随机透视变换
factor_up_down = 16
factor_left_right = 32
factor_true = 5

# 模糊程度高
# gaussianradius = [2,2,2,2,2,2,2,2,1,3]
# 模糊程度低
gaussianradius = [1,2,1,2,1,1,2,1,2,1]
...
if __name__ == '__main__':
    ...
    for i in range(cnt):
        ...
        cv2.imencode('.png', img)[1].tofile('F:/SmartSite/plate_generator_master/greenplate2/' + platenumber + '.png')
